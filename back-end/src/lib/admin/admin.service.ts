...
export class AdminService {
  ...
  constructor(
    ...
    @InjectModel(Company) readonly companyModel: ReturnModelType<typeof Company>,
  ) { }
  ...
  async createAdmin() {
    ...
    user = await this.userModel.findByIdAndUpdate(user._id, updateDoc, { new: true });
    console.log(user);
    company = await this.companyModel.findByIdAndUpdate(company._id, updateDoc, { new: true });
