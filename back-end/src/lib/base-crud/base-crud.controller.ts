import {
  ...
  ValidationPipe, ValidationPipeOptions, ArgumentMetadata, UsePipes, Query, UseGuards
} from '@nestjs/common';
...
export function BaseControllerFactory<T extends BaseEntity = BaseEntity>(bodyDto: Type<T>): Type<IController<T>> {
  @Controller()
  // 가드 적용: 로그인 된 연결만을 허용
