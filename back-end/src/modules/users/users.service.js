...
var UsersService = /** @class */ (function (_super) {
    ...
    UsersService.prototype.findUserBySignInInfo = function (userInfo) {
        return __awaiter(this, void 0, void 0, function () {
            var searchOption, user, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.model.findOne(searchOption).select('+password')];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new common_1.UnauthorizedException();
                        }
                        result = (0, bcrypt_1.compareSync)(userInfo.pwd, user.password);
                        if (result) {
    ...
    UsersService.prototype.findUserByHpNumber = function (hpNumber) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.model.findOne({ hpNumber: hpNumber })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
