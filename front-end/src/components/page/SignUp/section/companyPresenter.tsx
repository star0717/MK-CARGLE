            ...
            >
              ...
              {errors.cAddressMain?.type === "required" && (
                <Text
                  ...
                  fontSize={`14px`}
                  textAlign={`left`}
                >{errors.cAddressMain.message}</Text>
              )}
            </Wrapper>
            <TextInput2
              width={width < 1439 ? (width < 500 ? `300px` : `1000px`) : `1200px`}
