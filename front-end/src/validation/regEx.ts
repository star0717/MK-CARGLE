...
export const formRegEx = {
  ...
  // CAR_ID_NUM:
  //   /[0-9A-Z]{1}[V,A,B,D,P,N,L,M,P,R]{1}[H,J,F,C,B]{1}[A-G]{1}[A,B,H,L,M,N]{1}[0-6,8]{1}[1-4]{1}[A-C]{1}[0-9,P,R]{1}[T,V,Y,1,2,9,A,B]{1}[A,C,U,M]{1}[000000-999999]{6}$/,
  CAR_ID_NUM: /^[a-zA-Z0-9]{17,}$/,
  MONEY: /^[0-9,]*$/,
};
